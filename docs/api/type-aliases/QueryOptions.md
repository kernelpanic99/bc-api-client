...
| ------ | ------ | ------ | ------ |
| `key` | `string` | Query parameter name for value filtering (e.g., `'id:in'`). | lib/request.ts:187 |
| `values` | (`string` \| `number`)[] | Values to filter by. Automatically chunked across multiple requests. | lib/request.ts:189 |
